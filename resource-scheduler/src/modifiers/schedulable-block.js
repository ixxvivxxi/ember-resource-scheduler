 ...
 */
export default modifier(function schedulableBlock(
  element,
  [block],
  {
    mode = 'move',
  ...
  function handlePointerDown(event) {
    ...
    const rowsContentElement =
      mode === 'move' ? rowsContentElementFor(element) : null;
    ...
    const pinned =
      mode === 'move' && pinnedLaneLayout
        ? { layout: pinnedLaneLayout, element: pinnedRowsElementFor(element) }
        : null;
    ...
    function handlePointerMove(moveEvent) {
      ...
      if (mode === 'move') {
        ...
        const located = resourceLaneForClientPoint(
          moveEvent.clientX,
          moveEvent.clientY,
          laneLayout,
          rowsContentElement,
