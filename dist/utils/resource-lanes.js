 ...
 */
function computeGaps(items, options = {}) {
  const {
  ...
  if (rangeEnd !== undefined && cursor !== undefined && compare(cursor, rangeEnd) < 0) {
    gaps.push({
      start: cursor,
      end: rangeEnd
    });
...
export { assignLanes, computeGaps };
//# sourceMappingURL=resource-lanes.js.map
